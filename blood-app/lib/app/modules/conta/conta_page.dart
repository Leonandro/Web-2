...
void handleAccountDeletion(int userId) async {
  SharedPreferences prefs = await SharedPreferences.getInstance();
  EasyRequest.deleteUser(userId.toString())
      .then((value) => {print("DELETING " + value.body)});
                                ...
                                children: [
                                  ...
                                  if (BackendRoutes.BACKEND_MODE ==
                                    ...
                                    Text(' Desejo deletar minha conta',
                                        style:
                                            (AppTheme.semibold_small_delete)),
                                ],
                              )),
                        ),
                        Padding(
